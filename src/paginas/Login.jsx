...
const Login = () => {
    ...
    return (
        <>
            <div>
                <h1 className="text-pink-400 font-black text-6xl">Inicia sesión y Administra tus
                    <span className="text-pink-800"> Clientes</span></h1>
            </div>
            {<div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl ">
                ...
                >
                    ...
                    <div className="my-5">
                        <label className="uppercase text-pink-400 block text-xl font-bold">Password</label>
                        <input
                            type="password"
                ...
                <nav className="mt-10 lg:flex lg:justify-between">
                    ...
                    <Link
                        className="block text-center my-5 text-gray-500"
                        to="/olvide-password">Recupera tu Password</Link>
                </nav>
            </div>
            }
